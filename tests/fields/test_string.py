...
from jsonschema_formful.field import StringParameters
...
def test_email_format():
    ...
    assert field.get_factory() == formful.fields.EmailField
...
def test_date_format():
    ...
    assert field.get_factory() == formful.fields.DateField
...
def test_time_format():
    ...
    assert field.get_factory() == formful.fields.TimeField
...
def test_datetime_format():
    ...
    assert field.get_factory() == formful.fields.DateTimeField
...
def test_uri_format():
    ...
    assert field.get_factory() == formful.fields.URLField
...
def test_password_format():
    ...
    assert field.get_factory() == formful.fields.PasswordField
    form = formful.form.BaseForm({"test": field()})
    form.process()
    assert form._fields['test']() == (
        '<input id="test" '
...
def test_IP_format():
    ...
    assert field.get_factory() == formful.fields.StringField
    ...
    hamcrest.assert_that(constraints, hamcrest.has_entries({
        'validators': hamcrest.contains_exactly(
            ...
            hamcrest.instance_of(formful.validators.IPAddress)
        ),
    }))
...
def test_binary():
    ...
    assert field.get_factory() == formful.fields.simple.FileField
    form = formful.form.BaseForm({"test": field()})
    assert form._fields['test']() == (
...
def test_length():
    ...
    hamcrest.assert_that(constraints, hamcrest.has_entries({
        'validators': hamcrest.contains_exactly(
            hamcrest.instance_of(formful.validators.DataRequired),
            hamcrest.instance_of(formful.validators.Length)
        ),
    }))
...
def test_pattern():
    ...
    hamcrest.assert_that(constraints, hamcrest.has_entries({
        'validators': hamcrest.contains_exactly(
            hamcrest.instance_of(formful.validators.DataRequired),
            hamcrest.instance_of(formful.validators.Regexp)
        ),
    }))
...
def test_enum():
    ...
    assert field.required is True
    assert field.get_factory() == formful.fields.SelectField
    form = formful.form.BaseForm({"test": field()})
    form.process(data={'test': 'Dagger'})
    assert form.validate() is False
...
def test_unhandled_attribute():
    ...
    assert str(exc.value) == (
        ...
        "<class 'jsonschema_formful.field.StringParameters'>."
    )
